...
table2_1 <- data.frame(Organism = c("_Thiosphaera pantotropha_ L.M.D. 92.63", "_Pseudomonas stutzeri_ A.T.C.C. 14405", "_Pseudomonas aeruginosa_ PAO1",
                       ...
                       Reference = c("Thompson _et al_. (1997); Robertson and Kuenen (1983)  [@thompson_variation_1997; @robertson_thiosphaera_1983]", "Döhler _et al_. (1983) [@dohler_transfer_1987]", "Holloway _et al_. (1979) [@holloway_chromosomal_1979]",
                                     "Yanisch-Perron _et al_. (1985) [@yanisch-perron_improved_1985]", "Yanisch-Perron _et al_. (1985) [@yanisch-perron_improved_1985]", "Hanahan (1983) [@hanahan_studies_1983]", "Simon _et al_. (1983) [@simon_broad_1983]"),
...
For some experiments _T. pantotropha_ was grown anaerobically in minimal succinate medium [@burnell_reversibility_1975].
...
Hoagland's trace elements solution [@burnell_reversibility_1975] was added at 100 $\mu$l l$^{-1}$.
...
_Ps. stutzeri_ ATCC 14405 was grown anaerobically using ACN medium [@coyle_nitrous_1985].
...
Sulphur-free trace metals solution [@cole_nitrite_1974] was added at 1 ml l$^{-1}$.
...
Plasmid DNA was sequenced by the dideoxy-chain termination method [@sanger_dna_1977], using the Sequenase 2.0 kit (Amersham). Sequencing was divided into three stages: template denaturation plus primer annealing, labelling and termination.
